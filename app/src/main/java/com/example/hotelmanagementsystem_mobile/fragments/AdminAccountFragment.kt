...
class AdminAccountFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        name = requireView().findViewById<TextView>(R.id.textViewAdminUserName)
        ID = requireView().findViewById<TextView>(R.id.textViewAdminID)
        email = requireView().findViewById<TextView>(R.id.textViewAdminEmail)
